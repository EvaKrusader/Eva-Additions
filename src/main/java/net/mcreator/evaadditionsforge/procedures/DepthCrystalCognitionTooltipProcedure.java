...
public class DepthCrystalCognitionTooltipProcedure {
	public static void execute(Entity entity, ItemStack itemstack, List<Component> tooltip) {
		...
		item1 = new ItemStack(EvaAdditionsModItems.CRYSTAL_DEPTH.get());
		item2 = new ItemStack(EvaAdditionsModItems.CRYSTAL_OXYGEN.get());
		item3 = new ItemStack(EvaAdditionsModItems.CRYSTAL_EARTH.get());
